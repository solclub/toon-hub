...
export const confirmTransactionWithRetry = async (connection: Connection, txId: string) => { 
...
async function isBlockhashExpired(initialBlockHeight:number, connection: Connection) {
