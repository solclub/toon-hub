...
export default function GiblatoonsUpgradeModal({
  ...
  return (
    <Modal isOpen={isModalOpen} backdropDismiss={true} handleClose={() => setModalOpen(false)}>
      <div className="flex w-full flex-col items-center justify-between lg:flex-row">
        ...
        {!nft.images.has(upgradeOpt.key) && (
          <div className="flex flex-col items-center gap-4 text-sm md:flex-row md:gap-2">
